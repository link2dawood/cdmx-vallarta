<?php
include 'header.php';
?><title>Cannabis Marijuana Research Report Is marijuana safe effective as medicine - 420 Puerto Vallarta - Nuevo Vallarta</title>
    ...
    <div class="col-md-7">
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-4 ml-auto">
                <h3>Cannabis (Marijuana) Research Report; Is marijuana safe and effective as medicine?</h3>
            <p>The potential medicinal properties of marijuana and its components have been the subject of research and heated debate for decades. THC itself has proven medical benefits in particular formulations. The U.S. Food and Drug Administration (FDA) has approved THC-based medications, dronabinol (Marinol&reg;) and nabilone (Cesamet&reg;), prescribed in pill form for the treatment of nausea in patients undergoing cancer chemotherapy and to stimulate appetite in patients with wasting syndrome due to AIDS.<br />
              In addition, several other marijuana-based medications have been approved or are undergoing clinical trials. Nabiximols (Sativex&reg;), a mouth spray that is currently available in the United Kingdom, Canada, and several European countries for treating the spasticity and neuropathic pain that may accompany multiple sclerosis, combines THC with another chemical found in marijuana called cannabidiol (CBD).<br />
              <br />
              The FDA also approved a CBD-based liquid medication called Epidiolex&reg; for the treatment of two forms of severe childhood epilepsy, Dravet syndrome and Lennox-Gastaut syndrome. It&rsquo;s being delivered to patients in a reliable dosage form and through a reproducible route of delivery to ensure that patients derive the anticipated benefits. CBD does not have the rewarding properties of THC.<br />
              <br />
              ...
              <br />
              An additional concern with &quot;medical marijuana&quot; is that little is known about the long-term impact of its use by people with health- and/or age-related vulnerabilities&mdash;such as older adults or people with cancer, AIDS, cardiovascular disease, multiple sclerosis, or other neurodegenerative diseases. Further research will be needed to determine whether people whose health has been compromised by disease or its treatment (e.g., chemotherapy) are at greater risk for adverse health outcomes from marijuana use.<br />
              <br />
              <strong>              Medical Marijuana Laws and Prescription Opioid Use Outcomes<br />
              </strong>A new study underscores the need for additional research on the effect of medical marijuana laws on opioid overdose deaths and cautions against drawing a causal connection between the two. Early research suggested that there may be a relationship between the availability of medical marijuana and opioid analgesic overdose mortality. In particular, a NIDA-funded study published in 2014 found that from 1999 to 2010, states with medical cannabis laws experienced slower rates of increase in opioid analgesic overdose death rates compared to states without such laws.78<br />
              <br />
