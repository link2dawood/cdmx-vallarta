<?php
include 'header.php';
?><title>Landrace Strains Heirlooms - 420 Puerto Vallarta - Nuevo Vallarta</title>
    ...
    <div class="col-md-7">
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-4 ml-auto">
                <h3><strong>Landrace Strains &amp; Heirlooms</strong></h3>
                <p><br />
                  Landrace strains are those that evolved naturally within their native environments. Because they weren&rsquo;t bred and aren&rsquo;t hybrids, landrace strains offer a very pure example of sativa or indica, with no interference from humans. In fact, landrace strains are typically 100 percent indica or sativa, the result of tens of thousands of years of inbreeding in a particular weather climate and geography.<br />
                  <br />
